package com.kakao.lango.springbootmybatis.config;
...
@MapperScan(basePackages = {"com.kakao.lango.springbootmybatis.persistence"})
public class MyBatisConfig {
    @Bean
    public DataSource batisDataSource() {
        HikariConfig hikariConfig = new HikariConfig();
        hikariConfig.setDriverClassName("org.mariadb.jdbc.Driver");
        hikariConfig.setJdbcUrl("jdbc:mariadb://localhost:3306/lango");
        hikariConfig.setUsername("guest1");
        hikariConfig.setPassword("guest1");
